  ...
  return (
    ...
    <div className="w-full max-h-full flex  flex-wrap p-4 item-start  gap-0 overflow-y-scroll">
      ...
      <div className="w-[45%] flex flex-col h-[80px] p-2">
        <label className="text-secondary-color text-lg font-semibold mb-2 flex items-center gap-2">Alternative Names<span className="flex justify-center items-center h-full italic font-thin"><CiCircleInfo /> Comma separated</span></label>
